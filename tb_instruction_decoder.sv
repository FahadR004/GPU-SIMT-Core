...
module tb_instruction_decoder;
    ...
    initial begin
        ...
        check(
            ...
            4'h0, 5'd3, 5'd1, 5'd2, 1'b0, 32'd0,
            "ADD r3,r1,r2"
        );
        ...
        check(
            ...
            4'h1, 5'd5, 5'd4, 5'd7, 1'b0, 32'd0,
            "SUB r5,r4,r7"
        );
        ...
        check(
            ...
            4'h0, 5'd2, 5'd1, 5'd0, 1'b1, 32'd15,
            "ADD r2,r1, 15"
        );
        ...
        check(
            ...
            4'h0, 5'd2, 5'd1, 5'd0, 1'b1, 32'hFFFF_FFFF,
            "ADD r2,r1, -1"
        );
        ...
        check(
            ...
            4'h3, 5'd0, 5'd0, 5'd0, 1'b0, 32'd0,
            "AND r0,r0,r0"
        );
        ...
        check(
            ...
            4'h6, 5'd31, 5'd31, 5'd31, 1'b0, 32'd0,
            "SLT r31,r31,r31"
        );
        ...
        check(
            ...
            4'h8, 5'd1, 5'd2, 5'd0, 1'b1, 32'd8,
            "LOAD r1, 8(r2)"
        );
        ...
        check(
            ...
            4'h8, 5'd5, 5'd3, 5'd0, 1'b1, 32'hFFFF_FFFC, 
            "LOAD r5, -4(r3)"
        );
        ...
        check(
            ...
            4'h9, 5'd0, 5'd2, 5'd4, 1'b1, 32'd8,
            "STORE r4, 8(r2)"
        );
        ...
        check(
            ...
            4'h9, 5'd0, 5'd6, 5'd7, 1'b1, 32'd0,
            "STORE r7, 0(r6)"
        );
